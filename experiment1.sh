...
if [ $# -eq 0 ]
then
  echo "Specify the number of samples per configuration (e.g. './experiment1.sh 1000' )."
  exit 1
else
  SAMPLES=$1
...
###
python main.py experiment1 --synthetic --cores $CORES --automotivePeriods -minlength 2 --maxlength 50 --incrementlength 2 --experimentCount $SAMPLES --seed 123