...
class DptJob:
    ...
    def __init__(self, job):
        ...
        self.ri = [job.release, job.deadline - job.task.wcet]                       # The read interval of the job (i.e. when data might be read). 
        self.di = [job.release + job.task.wcet, job.deadline + job.task.period]     # The data interval of the job (i.e. when data produced can be available).
...
if __name__ == '__main__':
    ...
    task1 = Task('Task1', mseconds(1), mseconds(40), mseconds(40), 0)
    task2 = Task('Task2', mseconds(1), mseconds(80), mseconds(80), 0)
    task3 = Task('Task3', mseconds(1), mseconds(20), mseconds(20), 0)
